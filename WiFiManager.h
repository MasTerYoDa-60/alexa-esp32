/**************************************************************
   ...
   Reviewed by  Fernando Belíssimo - aug/18/2021
 **************************************************************/
...
// const char HTTP_FORM_START[] PROGMEM      = "<form method='get' action='wifisave'><input id='s' name='s' length=32 placeholder='SSID'><br/><input id='p' name='p' length=64 type='password' placeholder='password'><br/>"; // fernando era assim
...
const char HTTP_SAVED[] PROGMEM           = "<div>Credenciais Salvas<br />Religue o equipamento em caso de desconexão<br />By Fernando Belissimo...</div>";
